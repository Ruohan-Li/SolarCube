...
parser.add_argument('--label_len', type=int, default=12, help='start token length of Informer decoder') #short 12 long 24
...
parser.add_argument('--patch_len', type=int, default=8, help='patch length')    #short 8
parser.add_argument('--stride', type=int, default=4, help='stride') #short 4
