...
parser.add_argument('--model', type=str, required=True, default='informer_noT',help='model of experiment, options: [informer, informerstack, informerlight(TBD)]')
...
parser.add_argument('--checkpoints', type=str, default='./if_checkpoints/', help='location of model checkpoints')
