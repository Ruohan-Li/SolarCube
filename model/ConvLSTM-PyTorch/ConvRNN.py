    ...
    def __init__(self, shape, input_channels, filter_size, num_features):
        ...
        self.conv1 = nn.Sequential(
            nn.Conv2d(self.input_channels + self.num_features,
                      ...
                      self.padding),
            nn.GroupNorm(2 * self.num_features // 30, 2 * self.num_features))
        self.conv2 = nn.Sequential(
            nn.Conv2d(self.input_channels + self.num_features,
                      self.num_features, self.filter_size, 1, self.padding),
            nn.GroupNorm(self.num_features // 30, self.num_features))
    ...
    def __init__(self, shape, input_channels, filter_size, num_features, seq_len):
        ...
        self.conv = nn.Sequential(
            nn.Conv2d(self.input_channels + self.num_features,
                      ...
                      self.padding),
            nn.GroupNorm(4 * self.num_features // 30, 4 * self.num_features))
