...
def customized1(input_shape, P=2):
    T, H, W, _ = input_shape
    cuboid_size = [(T, 1, 1), (1, H//P, W//P), (1, H//P, W//P)]
    strategy = [('l', 'l', 'l'), ('l', 'l', 'l'), ('l', 'l', 'l')]
    shift_size = [(0, 0, 0), (0, 0, 0), (0, H//4, W//4)]
    return cuboid_size, strategy, shift_size

def customized2(input_shape, P=2, M=4):
    T, H, W, _ = input_shape
    P = min(P, T)
    M = min(M, H, W)
    cuboid_size = [(P, M, M)]
...
CuboidSelfAttentionPatterns.register('divided_st2', customized1)
CuboidSelfAttentionPatterns.register('video_swin_2', customized2)
