...
class InitialEncoder(nn.Module):
    def __init__(self,
        ...
        print('2initialencoder ', downsample_scale)
        ...
        conv_block = []
        print('input dim ', dim, 'output dim ', out_dim)
        ...
        # print('3patch_merge_down ',patch_merge_downsample)
...
class CuboidTransformerModel(nn.Module):
    ...
    def __init__(self,
        ...
        # print('new input shape ', new_input_shape)
    ...
    def get_initial_encoder_final_decoder(
        ...
        print('in!!!!!!!!!')
        print(T_in, H_in, W_in, C_in)
        T_out, H_out, W_out, C_out = self.target_shape
        print(T_out, H_out, W_out, C_out)
        ...
        if self.initial_downsample_type == "conv":
            ...
            # print('1initial_down', initial_downsample_scale)
